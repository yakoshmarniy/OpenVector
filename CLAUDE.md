...
**Следующее по порядку:** **Итерация 4** — доделать перо: Add/Delete/Convert Anchor Point,
Curvature Tool (Pen уже есть; Direct Selection двигает точки). Затем итерация 5 (свободное
рисование) и т.д. (итерации 5–7, 9 — не начаты).

...
**Следующее по плану (ранние пробелы):** 2.1 Magic Wand/Lasso/drawer · 2.2 трансформации мышью
(поворот рамкой, Reset BB, Reference Point, Alt-копия, Transform Again, Drawing/Screen Modes) ·
3.1 live shapes · 3.2 полная обводка (тип/концы/углы/пунктир/стрелки). Затем 5.2 Шрифты.
Идём по возрастанию номера фаз.

...
**Следующее по плану:** **фаза 5.2** — Шрифты (системные, загрузка .ttf/.otf, Google Fonts,
менеджер, превью; Retype отложить). При желании можно сначала закрыть ранние пробелы:

...
### Итерация 6 — Группировка и булевы операции ← ✅ готово
- [x] Мульти-выделение: Shift+клик добавляет/убирает; рамка вокруг всех + по каждому
- [x] Группировка / разгруппировка (кнопки в панели + Cmd/Ctrl+G, Cmd/Ctrl+Shift+G)

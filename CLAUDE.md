...
**Следующее по плану (ранние пробелы):** 3.1 live shapes · 3.2 полная обводка
(тип/концы/углы/пунктир/стрелки). Затем 5.2 Шрифты. Хвост 2.2 (Reference Point, Reset BB +
поворотный бокс, Transform Again, Drawing/Screen Modes) отложен до 7.1 (Transform-панель). Идём по фазам.

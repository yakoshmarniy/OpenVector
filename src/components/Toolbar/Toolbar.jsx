...
const GROUPS = [
  ...
  [TOOLS.SHAPE_BUILDER],
  [TOOLS.ROTATE, TOOLS.REFLECT],
  [TOOLS.SCALE, TOOLS.SHEAR, TOOLS.RESHAPE],
  [TOOLS.FREE_TRANSFORM],
  // Illustrator keeps the seven Liquify brushes in the Width tool's slot.
  [
  ...
  [TOOLS.GRADIENT, TOOLS.MESH, TOOLS.EYEDROPPER, TOOLS.MEASURE, TOOLS.DIMENSION],
